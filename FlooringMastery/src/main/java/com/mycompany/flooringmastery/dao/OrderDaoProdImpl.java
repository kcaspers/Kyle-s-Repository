...
//          ArrayList<String> currentTokensList = new ArrayList<>();
//            while (scanner.hasNextLine()){
//                currentLine = scanner.nextLine();
//                currentTokensList = customSplitSpecific(currentLine);
//                
//                Order currentOrder = new Order(currentTokensList.get(1), currentTokensList.get(2),
//                currentTokensList.get(4), currentTokensList.get(5));
//                currentOrder.setOrderNumber(Integer.parseInt(currentTokensList.get(0)));
//                currentOrder.setTaxRate(new BigDecimal(currentTokensList.get(3)));
//                currentOrder.getProduct().setCostPerSquareFoot(new BigDecimal(currentTokensList.get(6)));
//                currentOrder.getProduct().setLaborCostPerSquareFoot(new BigDecimal(currentTokensList.get(7)));
//                currentOrder.setMaterialCost(new BigDecimal(currentTokensList.get(8)));
//                currentOrder.setLaborCost(new BigDecimal(currentTokensList.get(9)));
//                currentOrder.setTax(new BigDecimal(currentTokensList.get(10)));
//                currentOrder.setTotal(new BigDecimal(currentTokensList.get(11)));
//                
//                ordersByDateFromFile.add(currentOrder);
//            }

            while (scanner.hasNextLine()) {
                //I need a way for it to ignore commas in quotes
                currentLine = scanner.nextLine();
...
//                currentOrder.setOrderName(alteredCompanyName);
                //put all names with commas in quotes
                String newCompanyName = currentOrder.getOrderName();
                if(newCompanyName.contains(",")){
                    newCompanyName = "'" + newCompanyName + "'";
                }
                currentOrder.setOrderName(newCompanyName);
